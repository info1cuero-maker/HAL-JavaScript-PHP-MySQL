...
INSERT INTO pages (slug, title_uk, title_ru, meta_title_uk, meta_title_ru, meta_description_uk, meta_description_ru, meta_keywords_uk, meta_keywords_ru) VALUES
('home', 'Головна', 'Главная', 'HAL - Каталог компаній України', 'HAL - Каталог компаний Украины', 'Знайдіть найкращі компанії та послуги у вашому місті. Відгуки, рейтинги, контакти.', 'Найдите лучшие компании и услуги в вашем городе. Отзывы, рейтинги, контакты.', 'каталог компаній, послуги, бізнес, Україна', 'каталог компаний, услуги, бизнес, Украина'),
('search', 'Пошук', 'Поиск', 'Пошук компаній - HAL', 'Поиск компаний - HAL', 'Пошук компаній та послуг по всій Україні. Фільтрація по категоріям та містам.', 'Поиск компаний и услуг по всей Украине. Фильтрация по категориям и городам.', 'пошук компаній, каталог послуг', 'поиск компаний, каталог услуг'),
('blog', 'Блог', 'Блог', 'Блог - HAL', 'Блог - HAL', 'Корисні статті, новини та поради для бізнесу.', 'Полезные статьи, новости и советы для бизнеса.', 'блог, статті, новини', 'блог, статьи, новости'),
('about', 'Про нас', 'О нас', 'Про нас - HAL', 'О нас - HAL', 'Дізнайтеся більше про платформу HAL та нашу місію.', 'Узнайте больше о платформе HAL и нашей миссии.', 'про нас, про HAL', 'о нас, о HAL'),
('contacts', 'Контакти', 'Контакты', 'Контакти - HAL', 'Контакты - HAL', 'Зв''яжіться з нами. Контактна інформація та форма зворотного зв''язку.', 'Свяжитесь с нами. Контактная информация и форма обратной связи.', 'контакти, зворотній зв''язок', 'контакты, обратная связь')
ON DUPLICATE KEY UPDATE slug=slug;
